...
#define TOKEN "BBFF-npRftW1ZoTgW9tBwIoNa0QPxfM57ay" // Ubidots TOKEN name el mismo que usamos en clase
#define MQTT_CLIENT_NAME "a1a2a3a4a5" //ID del cliente, 8 a 12 chars alfanumericos (ASCII), debe ser random y unico dif a otros devices
#define VARIABLE_LABEL_temp "temperatura" // Variable Temperatura
#define VARIABLE_LABEL_hum "humedad" // Variable Humedad
#define DEVICE_LABEL "arduino_device" // Nombre del dispositivo a crear
